...
G4PolarizedParticleHPElasticData::G4PolarizedParticleHPElasticData()
:G4VCrossSectionDataSet("PolarizedNeutronHPElasticXS")
{
...
G4bool G4PolarizedParticleHPElasticData::IsIsoApplicable( const G4DynamicParticle* dp , 
							  G4int /*Z*/ , G4int /*A*/ ,
							  const G4Element* /*elm*/ ,
...
G4double G4PolarizedParticleHPElasticData::GetIsoCrossSection(const G4DynamicParticle* dp,
							      G4int /*Z*/ , G4int /*A*/ ,
							      const G4Isotope* /*iso*/  ,
...
/*
G4bool G4PolarizedParticleHPElasticData::IsApplicable(const G4DynamicParticle*aP, const G4Element*)
{
  G4bool result = true;
...
void G4PolarizedParticleHPElasticData::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
...
void G4PolarizedParticleHPElasticData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
...
G4double G4PolarizedParticleHPElasticData::
...
G4int G4PolarizedParticleHPElasticData::
GetVerboseLevel() const 
{
   return G4ParticleHPManager::GetInstance()->GetVerboseLevel();
}

void G4PolarizedParticleHPElasticData::
SetVerboseLevel( G4int newValue ) 
{
   G4ParticleHPManager::GetInstance()->SetVerboseLevel(newValue);
}
void G4PolarizedParticleHPElasticData::CrossSectionDescription(std::ostream& outFile) const
{
